...
public class BillDAO {
	...
	private static final String SQL_SELECT_BY_USERID = "SELECT * FROM racun WHERE korisnik_id=?";
	private static final String SQL_BILL_UPDATE = "UPDATE racun set dozvola_placanja = ? where  korisnik_id = ?";
